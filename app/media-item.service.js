    ...
    return {
        ...
        execute: function() {
            MediaItemService = (function () {
                ...
                MediaItemService.prototype.set = function (mediaItem) {
                    return this.http.post('mediaitems', mediaItem).map(function (response) { });
                };
                MediaItemService.prototype.delete = function (mediaItem) {
                    return this.http.delete("mediaitems/" + mediaItem.id).map(function (response) { });
                };
